...
export default function AddCollectionModal({
  ...
  onClose,
  themeColors = {
    borderDefault: "border-[#424242]",
    borderHover: "hover:border-[#D99C6A]",
    focusBorder: "focus:border-[#D99C6A]",
    saveButtonBg: "bg-[#D99C6A]",
    saveButtonHoover: "hover:bg-[#c46518]",
  },
}: Props) {
      ...
      <div className="relative w-full max-w-2xl h-1/2 bg-white rounded-2xl shadow-xl flex flex-col max-h-[80vh] z-10">
        ...
        <div className="flex flex-1 flex-col p-8 gap-5">
          ...
          <div className="flex flex-row justify-end gap-5">
            ...
            <button
              onClick={handleSave}
              className={`py-2 rounded-md text-white font-semibold w-48 cursor-pointer hover:brightness-120 transition-all duration-300 ${saveButtonBg} ${saveButtonHoover}`}
            >
              Salvar
            </button>
          </div>
